...
> Groundedness and trustworthiness scoring harness validating context retrieval quality scores.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/cleanlab-evaluator/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-cleanlab-evaluator.git
cd tp-cleanlab-evaluator
```
...
```bash
kubectl port-forward deployment/tp-cleanlab-evaluator 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── trust_evaluator.py     # Main configuration file
```
...
---
*Generated by [Cleanlab RAG Evaluator Studio](https://pradeeptalari14.github.io/portfolio/tools/cleanlab-evaluator/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
